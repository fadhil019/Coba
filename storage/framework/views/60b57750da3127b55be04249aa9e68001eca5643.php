                    ...
                    <div class="modal-dialog">
                        <div class="modal-content  bg-warning">
                            ...
                            <div class="modal-body">
                                <form method="GET" action="<?php echo e(url('proses_upah_admin/'. $data_periodes->id_periode )); ?>" enctype="multipart/form-data">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROJECT\KERJAAN\JOKI\TA-FADHIL-NEW\resources\views/karyawan_admin/point/point.blade.php ENDPATH**/ ?>