                    ...
                    <tbody>
                        <?php $__currentLoopData = $data_pasien_rawat_jalans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data_pasien_rawat_jalan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e($data_pasien_rawat_jalan->tgl_masuk); ?></td>
                                <td><?php echo e($data_pasien_rawat_jalan->tgl_keluar); ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROJECT\KERJAAN\TA-FADHIL\resources\views/pasien/rawat_jalan.blade.php ENDPATH**/ ?>