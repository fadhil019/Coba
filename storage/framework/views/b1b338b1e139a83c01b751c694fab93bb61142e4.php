                            ...
                            <div class="modal fade" id="edit_dpjp">
                                <div class="modal-dialog">
                                    <div class="modal-content  bg-primary">
                                        ...
                                        <form method="POST" action="<?php echo e(route('data_pasien.update', $data_pasien_rawat_inaps[0]->id_data_pasien)); ?>" enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="id_dpjp">
                                                    <?php $__currentLoopData = $data_dokters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data_dokter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($data_dokter->id_dokter); ?>" <?php if($data_pasien_rawat_inaps[0]->id_dpjp == $data_dokter->id_dokter): ?> selected <?php endif; ?>><?php echo e($data_dokter->nama_dokter); ?></option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROJECT\KERJAAN\TA-FADHIL\resources\views/pasien/rawat_inap_tambah_tindakan.blade.php ENDPATH**/ ?>