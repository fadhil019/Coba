                ...
                <div class="modal fade" id="create_data">
                    <div class="modal-dialog">
                        <div class="modal-content  bg-warning">
                            ...
                            <h4 class="modal-title">Proses perhitungan upah karyawan perawat</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span></button>
                            </div>
                            <div class="modal-body">
                                <form method="GET" action="<?php echo e(url('proses_upah_perawat/'. $data_periodes->id_periode )); ?>" enctype="multipart/form-data">
                                    <div class="form-group">
                                            <label for="Name">Apakah anda yakin ingin memproses perhitungan upah karyawan perawat periode (<?php echo e($data_periodes->bulan); ?> - <?php echo e($data_periodes->tahun); ?>) ?</label>
                                        </div>
                                    <div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROJECT\KERJAAN\JOKI\TA-FADHIL-NEW\resources\views/karyawan_perawat/point/point.blade.php ENDPATH**/ ?>