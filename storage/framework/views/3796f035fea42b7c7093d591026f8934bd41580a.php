                    ...
                    <tbody>
                        <?php for($i=0; $i < count($rekap_data_dokters); $i++): ?>
                            <tr>
                                ...
                                <td><a href="<?php echo e(url('detail_rekap_data_dokter/'. $data_periodes->id_periode . '/' . $rekap_data_dokters[$i]['id_dokter'])); ?>" class="text-dark"><?php echo e($rekap_data_dokters[$i]['nama_dokter']); ?></a></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROJECT\KERJAAN\JOKI\TA-FADHIL-NEW\resources\views/rekap_data/daftar_rekap_data.blade.php ENDPATH**/ ?>