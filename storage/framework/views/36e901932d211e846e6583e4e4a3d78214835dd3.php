                ...
                <table class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <?php if($data_pasiens[0]->id_dpjp != null): ?>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $data_pasiens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row_data_pasiens): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <?php if($row_data_pasiens->id_dpjp != null): ?>
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <td style="background-color: orange;">Tindakan<br>Perawat ICCU</td>
                                <td style="background-color: orange;">Tindakan<br>Perawat RPP</td>
                                <?php $__currentLoopData = $data_dokters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <td>
                                ...
                                <td>
                                    <a href="<?php echo e(url('show_detail_proses_perhitungan_1/'.$id_periode.'/'.$id_ruangan.'/'.$row_data_pasiens->id_data_pasien )); ?>"  class="btn btn-success"><i class="fa fa-bars" aria-hidden="true"></i> Detail</a>
                                </td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody> 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROJECT\KERJAAN\TA-FADHIL\resources\views/proses_perhitungan/proses_perhitungan_1.blade.php ENDPATH**/ ?>