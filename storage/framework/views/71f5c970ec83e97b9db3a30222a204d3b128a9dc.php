    ...
    <div class="card">
        <div class="card-header">
            <div class="row pt-2 mb-2">
                <div class="col-sm-6">
                    <h1>Data tindakan pasien " <?php echo e($data_pasien_rawat_jalans[0]->nama_pasien); ?> "</h1>
                </div>
                <!-- <div class="col-sm-6">
                        ...
                        <div class="modal-content  bg-primary">
                            ...
                            <div class="modal-body">
                                <form method="POST" action="<?php echo e(route('data_tindakan_pasien.store')); ?>" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" class="form-control" name="id_data_pasien" value="<?php echo e($data_pasien_rawat_jalans[0]->id_data_pasien); ?>" required>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROJECT\KERJAAN\TA-FADHIL-NEW\resources\views/pasien/rawat_jalan_tindakan.blade.php ENDPATH**/ ?>