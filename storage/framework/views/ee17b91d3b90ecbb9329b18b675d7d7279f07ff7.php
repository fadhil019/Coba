                    ...
                    <tbody>
                        <?php $__currentLoopData = $data_pasien_rawat_inaps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data_pasien_rawat_inap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e($data_pasien_rawat_inap->tgl_masuk); ?></td>
                                <td><?php echo e($data_pasien_rawat_inap->tgl_keluar); ?></td>
                                
                                
                                
                                <td><?php echo e($data_pasien_rawat_inap->deskripsi_tindakan); ?></td>
                                <td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROJECT\KERJAAN\TA-FADHIL\resources\views/pasien/rawat_inap.blade.php ENDPATH**/ ?>