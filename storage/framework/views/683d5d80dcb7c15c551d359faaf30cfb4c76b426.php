...
<script>
  $(function () {
    ...
    $('#dataTable_pdf_dokter').DataTable({
      'paging'      : true,
      'lengthChange': true,
      'searching'   : true,
      'ordering'    : true,
      ...
      "responsive": true,    
      "buttons": ["pdf"]     
    }).buttons().container().appendTo('#tombol_pdf_dokter');
    $('#dataTable_pdf_penunjang').DataTable({
      'paging'      : true,
      'lengthChange': true,
      'searching'   : true,
      'ordering'    : true,
      ...
      "responsive": true,    
      "buttons": ["pdf"]     
    }).buttons().container().appendTo('#tombol_pdf_penunjang');
    $('#dataTable_pdf_perawat').DataTable({
      'paging'      : true,
      'lengthChange': true,
      'searching'   : true,
      'ordering'    : true,
      ...
      "responsive": true,    
      "buttons": ["pdf"]     
    }).buttons().container().appendTo('#tombol_pdf_perawat');
    $('#dataTable_pdf_admin').DataTable({
      'paging'      : true,
      'lengthChange': true,
      'searching'   : true,
      'ordering'    : true,
      ...
      "responsive": true,    
      "buttons": ["pdf"]     
    }).buttons().container().appendTo('#tombol_pdf_admin');
  });
...
</html><?php /**PATH D:\PROJECT\KERJAAN\JOKI\TA-FADHIL-NEW\resources\views/layouts/index.blade.php ENDPATH**/ ?>